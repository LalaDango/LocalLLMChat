...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_9_10 = object : Migration(9, 10) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE messages ADD COLUMN activeKvTokens INTEGER DEFAULT NULL")
                database.execSQL("ALTER TABLE messages ADD COLUMN maxKvTokenCapacity INTEGER DEFAULT NULL")
            }
        }
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                """)
                database.execSQL("CREATE INDEX IF NOT EXISTS index_message_images_messageId ON message_images(messageId)")
            }
        }
